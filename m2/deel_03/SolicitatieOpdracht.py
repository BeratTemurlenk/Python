...
if vraag_hoed == 'nee':
    raise NameError('Ze zijn 3 euro koop er eentje!')
vraag_gewicht = int(input('Hoeveel kilo weegt u?'))
if vraag_gewicht > 121:
    raise NameError('rol naar de sportschool flapdrol!')
vraag_lengte = int(input('Hoelang bent u (in centimeters)?'))
if vraag_lengte < 150:
    raise NameError('Je bent te klein gekkie!')
