...
woordlabel = tk.Label(root, text= f'woorden:', width=20, bg='black', fg='white')
aviLabel = tk.Label(root, text= f'score:', width=20, bg='black', fg='white')
...
woordlabel.place(x= 320, y= 560)
aviLabel.place(x= 450, y= 560)
# start program
